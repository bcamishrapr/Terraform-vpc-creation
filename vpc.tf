...
#Public Subnet where all the instances launched inside this subnet, will automatically be provided a public IP from which they will connect to the Internet Gateway.
